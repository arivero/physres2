...
\begin{equation*}
  W = \underbrace{\operatorname{Tr}(\hat m\, M)}_{\text{chiral mass}}
    ...
    + \underbrace{\lambda\, X\, H_u\!\cdot\!H_d}_{\text{NMSSM}}\,,
\end{equation*}
%
...
additional SUSY couplings (the $\lambda\,X\,H_u\!\cdot\!H_d$
...
and an NMSSM coupling $\lambda\,X\,H_u\!\cdot\!H_d$
($\lambda = 0.72$ for $m_h = 125\GeV$),
