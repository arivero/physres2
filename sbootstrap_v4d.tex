...
$Sp(2)$ SQCD with $N_f = 3$ antisymmetric flavors produces
three independent Pfaffian eigenvalues, and the
O'Raifeartaigh--Koide mechanism
($gv/m = \sqrt{3}$) generates $Q = 2/3$ at the seed.
...
A detailed construction of this sector is deferred to
future work.
...
The classic Weinberg--Oakes relation
$\tan\theta_C = \sqrt{m_d/m_s}$ gives $\theta_C = 12.6^\circ$
(PDG: $13.04^\circ$).
This relation emerges from the diagonalisation of the full
quark mass matrix after EWSB, and the tachyonic condensate
provides the dynamical origin: the instability \emph{forces}
off-diagonal VEVs, while the Yukawa coupling hierarchy selects
the Cabibbo angle through the Oakes mechanism.
...
GST: $|V_{us}| = \sqrt{m_d/m_s} = 0.224$ & Observed & $0.9\%$ from PDG~\cite{GST1968} \\
