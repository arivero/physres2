...
correction $|\!\sum s_k\sqrt{M^k{}_k}|^2$ from
monopole-instantons on $\mathbb{R}^3\times S^1$. After these constraints, only two to three
...
of the form $|\!\sum s_k\sqrt{m_k}|^2$. Expanding for
$N_c = 3$ diagonal mesons $M = \operatorname{diag}(M_1, M_2, M_3)$:
\begin{equation*}
...
$Q = 2/3$ translates exactly into a constraint on the Yukawa
couplings:
\begin{equation*}
  \frac{y_c^2 + y_b^2 + y_t^2}{(y_c + y_b + y_t)^2} = \frac{2}{3}\,.
\end{equation*}
With $y_t \approx 1$ fixed by the top mass, this determines the ratio
$y_b/y_t$ (and hence $y_c/y_t$ through the Koide parametrization).
...
the heavy sector. The bloom is non-holomorphic and lives in the
K\"ahler sector: the bion term $|\sum s_k\sqrt{M^k{}_k}|^2$ is the
leading monopole-instanton contribution on $\mathbb{R}^3 \times S^1$
(\S\ref{subsec:fterm}).
...
K\"ahler correction $K_{\text{bion}} \sim |\!\sum s_k\sqrt{M^k{}_k}|^2$
...
$v_0$-doubling observed to $0.025\%$ & Observed & Derived via bion K\"ahler \\
...
$m_b = 4{,}177 \pm 40\MeV$ from bion minimum & Derived & $0.06\sigma$ from PDG \\
$N_f = 4$ unique in ISS window & Derived & Only integer in $(3, 4.5)$ \\
ISS vacuum cosmologically stable & Derived & $\tau/T_U \sim 10^{247}$ \\
...
potential supplemented by a bion correction
$K_{\text{bion}} \sim |\!\sum s_k\sqrt{M^k{}_k}|^2$,
...
$|\!\sum s_k\sqrt{M^k{}_k}|^2$ predicts
