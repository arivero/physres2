...
observed lepton Koide phase to $5\,\text{ppm}$ ($1.1\sigma$
in $m_\tau$).
...
\begin{equation}
\delta_0 \bmod \frac{2\pi}{3} - \frac{2}{9} = -1.1 \times 10^{-6}\,,
\end{equation}
a residual of $\mathbf{5}$~\textbf{ppm} relative to $2/9$
(using PDG 2024 central masses; within the $m_\tau$ uncertainty
of $0.12\MeV$, the residual can vanish at $m_\tau \approx 1{,}776.99\MeV$,
i.e.\ $1.1\sigma$ above central).
...
on $[0, 2\pi/3)$) falls within $1.1 \times 10^{-6}$ of \emph{any}
of these 128 fractions gives a look-elsewhere-corrected significance
of $\mathbf{3.6\sigma}$. Evaluated specifically against the fraction
$2/9$ alone (i.e., without look-elsewhere correction), the
significance is $\mathbf{4.7\sigma}$.
The deviation from~$2/9$ is $1.1\sigma$ in the
...
$5\,\text{ppm}$ ($1.1\sigma$ in $m_\tau$; $3.6\sigma$ after
...
The physical minimum is a saddle point of the unconstrained
potential, so the correct treatment is perturbative:
the off-diagonal condensates should be computed as small
displacements around the Seiberg vacuum, not from global
minimization.
...
$\delta_\ell \bmod 2\pi/3 = 2/9$ to 5~ppm & Observed & $3.6\sigma$ after LEE \\
