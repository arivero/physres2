...
mechanism that generates the nonzero VEV
$\langle X\rangle = \sqrt{3}\,\mu$ required by the seed
remains an open question (\S\ref{sec:open}).
...
dual); the mechanism for the nonzero pseudo-modulus VEV remains open.
