...
charges via $Q = T_3 - Y/6$ to every component.
...
\toprule
& \multicolumn{6}{c}{Number of states at $|Q|$} & \\
\cmidrule(lr){2-7}
...
$\mathbf{24} \oplus \mathbf{15} \oplus \overline{\mathbf{15}}$
of $SU(5)$.
Notation ``$2\!\times\!k$'' means $k$ states at $+|Q|$ and $k$
at $-|Q|$; the $\mathbf{24}$ is self-conjugate.  In the
$\mathbf{15}$, the 9 states at $|Q|=2/3$ split as 3 from the
$(\mathbf{3},\mathbf{2})_{1/6}$ component at $Q = +2/3$ and 6
from the $(\mathbf{6},\mathbf{1})_{-2/3}$ color sextet at
$Q = -2/3$; the $\overline{\mathbf{15}}$ is the conjugate.
...
\begin{itemize}
\item \textbf{Neutral composites:} The 12 states at $Q = 0$
...
meson: $Q \cdot \ell \sim q\bar{q}$. Since the quark and antiquark 
...
$Q \cdot q_i \sim q_i q_j$. The bosonic SUSY generator applied to 
