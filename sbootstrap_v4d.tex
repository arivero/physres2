...
phase controls how the seed blooms into a full triple. The value
$\delta_\ell \approx 2/9$ for leptons must come from dynamics
beyond the seed mechanism.
...
enforces both Koide conditions simultaneously.
...
$\langle z_k^2\rangle = z_0^2$ constrains the initial conditions. The entire charged fermion and pseudoscalar meson
