...
The supermultiplets do \emph{not} align with Standard Model
generations. The quark content of each multiplet pairs up-type
with down-type quarks across generations --- schematically
$(t,s)$, $(u,b)$, $(c,d)$ --- so that the observed generation
structure $(u,d)$, $(c,s)$, $(t,b)$ emerges only after SUSY
breaking rearranges the mass eigenstates. The CKM matrix
measures the misalignment between these two bases.
