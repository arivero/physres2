...
A complete derivation requires solving the supermultiplet
restoration problem: tracking each fermion--scalar pair from the
SUSY limit through the breaking pattern to the physical spectrum.
