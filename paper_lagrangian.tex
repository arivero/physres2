...
The fundamental variable is the signed mass charge $\zch = z_0 + z_k
\in \mathbb{R}$, with the physical mass $m_k = \zch_k^2 \geq 0$.
For three charges $\zch_k = z_0 + z_k$ with $z_0$ the mean
($\sum z_k = 0$), the identity
\begin{equation}
\boxed{\langle z_k^2\rangle = z_0^2}
\end{equation}
states that the variance of the charge perturbations equals the
squared mean charge. It is equivalent to the ratio condition
$\sum m_k / (\sum \zch_k)^2 = 2/3$, since
$\sum \zch_k^2 = 3z_0^2 + \sum z_k^2$ and $(\sum\zch_k)^2 = 9z_0^2$.

\medskip\noindent\textit{Proof for the O'Raifeartaigh vacuum.}
The eigenvalue triple $(0,\, (2{-}\sqrt{3})\,m,\, (2{+}\sqrt{3})\,m)$
has mass charges $\zch_k = (0,\; \sqrt{2{-}\sqrt{3}}\,\sqrt{m},\;
\sqrt{2{+}\sqrt{3}}\,\sqrt{m}\,)$. The products
$\zch_-\,\zch_+ = \sqrt{(2{-}\sqrt{3})(2{+}\sqrt{3})}\,\sqrt{m}
= \sqrt{m}$, $\zch_-^2 + \zch_+^2 = 4\sqrt{m}$, and
$(\zch_- + \zch_+)^2 = 4 + 2 = 6$ (in units of $\sqrt{m}$). The
mean charge is $z_0 = (0 + \zch_- + \zch_+)/3 = \sqrt{6m}/3$.
Then $\langle z_k^2 \rangle = \frac{1}{3}(\zch_0^2 + \zch_-^2 +
\zch_+^2) - z_0^2 = 4m/3 - 6m/9 = 4m/3 - 2m/3 = 2m/3$ and
$z_0^2 = 6m/9 = 2m/3$. Therefore
$\langle z_k^2\rangle = z_0^2$ exactly.
\hfill$\square$

\medskip
This is a theorem about the O'Raifeartaigh superpotential at
$gv/m = \sqrt{3}$, not an empirical observation.
...
perturbations push $\langle z_k^2\rangle/z_0^2$ away from unity at any nonzero strength, making
