...
$\delta_0 \bmod 2\pi/3 = 2/9$ & 35 ppm & $0.9\sigma$ (in $m_\tau$) & 266 fractions & $3.1\sigma$ \\
...
GST: $\sin\theta_C = \sqrt{m_d/m_s}$ & $0.9\%$ & --- & --- & --- \\
\bottomrule
\end{tabular}
\end{center}
...
$\delta_0 \bmod 2\pi/3 = 2/9$ to 35~ppm gives $3.1\sigma$ with LEE
...
GST: $|V_{us}| = \sqrt{m_d/m_s} = 0.224$ & Observed & $0.9\%$ from PDG \\
