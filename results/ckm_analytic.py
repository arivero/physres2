...
print(f"     {'3x3 eigenvec, tachyon values (Scen. 1)':50s}  {t12_1:12.4f}  {np.sin(np.radians(t12_1)):12.6f}  {(t12_1-13.04)/13.04*100:+.2f}%")
print(f"     {'3x3 eigenvec, fitted eta (Scen. 4)':50s}  {t12_4:12.4f}  {np.sin(np.radians(t12_4)):12.6f}  {(t12_4-13.04)/13.04*100:+.2f}%")
print()

print("  5. FULL CKM (3x3 eigenvectors, fitted eta = {:.6f}):".format(best_eta))
...
# Jarlskog from O4: J = c12 s12 c23 s23 c13^2 s13 sin(delta) = 0 for real O
J_4 = 0.0
